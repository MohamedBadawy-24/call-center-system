...
app.use((req, res, next) => {
  ...
  if (urlPath.startsWith('/assets/') || urlPath === '/favicon.ico' || urlPath === '/manifest.json' || urlPath === '/robots.txt' || urlPath === '/sw.js' || urlPath === '/logo192.png' || urlPath === '/logo512.png' || urlPath === '/icon.png' || urlPath === '/logo.png') {
